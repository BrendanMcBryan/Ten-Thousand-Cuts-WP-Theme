 ...
 * Slug: ten-thousand-cuts/template-search-portfolio
...
<main class="wp-block-group alignfull">
	...
	<div class="wp-block-group alignwide">
		<!-- wp:pattern {"slug":"ten-thousand-cuts/hidden-search"} /-->
	</div>
	<!-- /wp:group -->

	<!-- wp:pattern {"slug":"ten-thousand-cuts/posts-images-only-3-col"} /-->
</main>
<!-- /wp:group -->
