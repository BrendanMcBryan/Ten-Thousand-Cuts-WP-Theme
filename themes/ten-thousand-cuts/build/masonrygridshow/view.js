...
console.log('Hello World! (from tenthousandcuts-masonrygridshow block)');
...
imagesloaded__WEBPACK_IMPORTED_MODULE_1___default()(grid, function () {
  ...
  msnry = new (masonry_layout__WEBPACK_IMPORTED_MODULE_0___default())(grid, {
